...
public class X8664CompilerFrontend {
    public static void usage() {
        System.out.println("Use: mjcompiler-x8664 <input filename>");
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(AsmX8664.compile(sprog));
    }
}
